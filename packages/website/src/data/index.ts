...
export const bio = {
  ...
  links: [
    { label: "GitHub" as const, url: "https://github.com/your-github" },
    { label: "LinkedIn" as const, url: "https://linkedin.com/in/your-linkedin" },
    { label: "Email" as const, url: "mailto:your@email.com" },
    { label: "Instagram" as const, url: "https://instagram.com/your-instagram" },
  ],
}
