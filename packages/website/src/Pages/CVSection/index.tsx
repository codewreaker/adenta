    ...
    <div id="cv" className={`cv-container gradient-bg`}>
      <div className="cv-paper">
        <div style={{ display: 'flex', gap: 20 }}>
          <GeometricCard width={360}>
            <p>
              This award recognizes outstanding contributions to the developer
              community, showcasing excellence in coding, problem-solving, and
              project execution.
            </p>
          </GeometricCard>
          <GeometricCard bg='var(--color-primary-grey)' />
        </div>
        ...
        >
          ...
          <div className="section-content">
            <p>
              ...
              building scalable web applications and modern UI libraries.
        ...
        <section
          ...
          className={`cv-section ${
            isVisible('cv-experience') ? 'visible' : ''
          }`}
        >
          ...
          <div className="section-content">
            ...
            <div className="experience-item">
              ...
              <ul className="achievements">
                <li>
                  Developed interactive web applications using modern JavaScript
                  frameworks
                </li>
          ...
          <div className="section-content">
            <div className="education-item">
              ...
              <p className="education-details">
                ...
                Engineering, Database Systems, Computer Networks
              </p>
            </div>
          </div>
        </section>
        ...
        <section
          ...
          className={`cv-section ${
            isVisible('cv-certifications') ? 'visible' : ''
          }`}
        >
